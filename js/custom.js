/* ----------------------------- 
Pre Loader - кружок загрузки в начале открытия сайта
----------------------------- */
...
/* ----------------------------- 
Backgroung - смена картинок на сайте (фон подложка)
----------------------------- */
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  ...
	  backgrounds:[
        ...
        { src:'images/bg-slider/bg-7.jpg', fade:1000 },
        { src:'images/bg-slider/bg-8.jpg', fade:1000 },
        { src:'images/bg-slider/bg-9.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-10.jpg', fade:1000 }
	  ]
	})();
});
...
/* ----------------------------- 
секция адрес + отправить сообщение
----------------------------- */			
$(document).ready(function() {
	'use strict';
